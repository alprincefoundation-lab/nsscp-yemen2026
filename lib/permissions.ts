 ...
 * Role-based access control with 7 RBAC levels
 * LEVEL 1: SUPER_ADMIN - Ministry of Interior
 * LEVEL 2: GOVERNORATE_ADMIN - One per governorate
 * LEVEL 3: DEPARTMENT_MANAGER - Managers of departments
 * LEVEL 4: SECTION_MANAGER - Section managers
 * LEVEL 5: OFFICER
 * LEVEL 6: DATA_ENTRY
 * LEVEL 7: VIEW_ONLY
 * 
