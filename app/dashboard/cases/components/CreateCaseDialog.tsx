...
import type { CaseCreateInput } from '../services/cases-api';
import { CASE_PRIORITIES, CASE_TYPES } from '../services/cases-api';
import { createCase } from '../services/cases-api';
...
export function CreateCaseDialog({ isOpen, onClose, onSuccess, hierarchyEntityId, userId, officerId }: CreateCaseDialogProps) {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        e.preventDefault();
        if (!formData.title.trim() || !formData.caseType) {
        ...
        try {
            ...
            if (response.success) {
                ...
                setError(response.error || 'فشل إنشاء القضية');
            }
        } catch (err) {
            setError(err instanceof Error ? err.message : 'فشل إنشاء القضية');
        } finally {
            ...
            <div className="flex items-center justify-center min-h-screen px-4">
                ...
                <div className="relative bg-white dark:bg-gray-900 rounded-xl shadow-xl border border-gray-200 dark:border-gray-700 w-full max-w-lg p-6 z-10">
                    <div className="flex justify-between items-center mb-6">
                        <h2 className="text-xl font-bold text-gray-900 dark:text-white">إنشاء قضية جديدة</h2>
